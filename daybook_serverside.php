...
protected $date;
	...
	function load_sells_data() {
		...
		$this->query_data = "SELECT SUM(total) FROM invoice WHERE date='101219'";
		$this->sql = mysqli_query($this->say->connect_form,$this->query_data);
		$this->fetch = mysqli_fetch_array($this->sql);
	...
	function load_purchase_data() {
		$this->date = $_POST["date"];
		echo "Purchases : -----------------------------------------------------------<br />";
		$this->query_data = "SELECT SUM(cash) FROM purchase_invoice WHERE date='101219'";
		$this->sql = mysqli_query($this->say->connect_form,$this->query_data);
		$this->fetch = mysqli_fetch_array($this->sql);
		echo "Cash: " . $this->fetch[0]. "<br /><br />";
		
		$this->query_data = "SELECT SUM(card1) FROM purchase_invoice WHERE date='101219'";
		$this->sql = mysqli_query($this->say->connect_form,$this->query_data);
		$this->fetch = mysqli_fetch_array($this->sql);
		$card1 = $this->fetch[0];
		echo "Card1: " . $card1  . "<br />";
		...
		$this->query_data = "SELECT SUM(card3) FROM purchase_invoice WHERE date='101219'";
		$this->sql = mysqli_query($this->say->connect_form,$this->query_data);
		$this->fetch = mysqli_fetch_array($this->sql);
		$card3 = $this->fetch[0];
		echo "Card3: " . $card3 . "<br />";
		...
		$this->query_data = "SELECT SUM(cheque1) FROM purchase_invoice WHERE date='101219'";
		$this->sql = mysqli_query($this->say->connect_form,$this->query_data);
		$this->fetch = mysqli_fetch_array($this->sql);
		echo "Cheque1: " . $this->fetch[0] . "<br />";
		
		$this->query_data = "SELECT SUM(cheque2) FROM purchase_invoice WHERE date='101219'";
		$this->sql = mysqli_query($this->say->connect_form,$this->query_data);
		$this->fetch = mysqli_fetch_array($this->sql);
		echo "Cheque2: " . $this->fetch[0] . "<br /><br />";
		
		$this->query_data = "SELECT SUM(total) FROM purchase_invoice WHERE date='101219'";
		$this->sql = mysqli_query($this->say->connect_form,$this->query_data);
		$this->fetch = mysqli_fetch_array($this->sql);
